 ...
 *
 * ControlParameter: a single value, either a double, vec3, or s64.  Each
...
#ifndef PROJECT_CONTROLPAREMETERS_HPP
#define PROJECT_CONTROLPAREMETERS_HPP
...
/*!
 * Value of a control parameter, maximum length is 12 double
 */
...
public:
    ...
    /*!
     * Construct control parameter for a list of Rows doubles
     * @param name : name of parameter
     * @param value : reference to value
     * @param collection : collection to add to
     * @param units : name of units
    ...
    /*!
     * Construct control parameter for a fixed size matrix
     * @param name : name of parameter
     * @param value : reference to value
     * @param collection : collection to add to
     * @param units : name of units
...
#endif  // PROJECT_CONTROLPAREMETERS_HPP
