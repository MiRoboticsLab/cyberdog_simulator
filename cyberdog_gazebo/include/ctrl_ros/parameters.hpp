//
// Created by hujian on 2021/5/28.
//
...
#define SPEED_CALIBRATE_FILE_PATH "/mnt/misc/speed_calibrate_param.yaml"

#define SPEED_PARAMETER_CALIBRATE_CONTROL_DEBUG 1

#define SPI_YAML_SH_PATH  "/robot-software/config/mini-cheetah-spi.yaml"
#define SPI_YAML_HAND_SH_PATH  "/robot-software/config/mini-cheetah-spi-hand.yaml"
#define SPI_YAML_HAND_SH_BAK_PATH  "/robot-software/config/mini-cheetah-spi-hand.yaml.bak"
